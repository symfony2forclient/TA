...
use TA\CurriculumBundle\Entity\Video;
use TA\CurriculumBundle\Form\VideoType;
use TA\CurriculumBundle\Form\VideoFilterType;
...
class VideoController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('TACurriculumBundle:Video')->createQueryBuilder('e');
    ...
    */
    protected function paginator($queryBuilder)
    {
        ...
        {
            return $me->generateUrl('video', array('page' => $page));
        };
     ...
     * @Method("POST")
     * @Template("TACurriculumBundle:Video:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TACurriculumBundle:Video')->find($id);
     ...
     * @Method("PUT")
     * @Template("TACurriculumBundle:Video:edit.html.twig")
     */
